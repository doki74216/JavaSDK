...
public class Neg_WebsiteSerialTesting{
    ...
    {
    	System.out.println("Bucket website InvalidAccessKeyId");
	...
	{
		System.out.println("Bucket website InvalidSecretKeyId");
    	
		String bucketName="region";
		
		System.out.println("\nExpect 403 SignatureDoesNotMatch");
    	System.out.println("===================================================");
    	AmazonS3  s3 = new AmazonS3Client((AWSCredentials) new BasicAWSCredentials("adc98059ceb7f848d819e3da1400ab00", "A8ca94ece8b03b8f44210ef31d0e8e41eae6cd554bf48557581fdd47685dbe799"));
    ...
    private static void PutbucketWebsite_404_NosuchBucket() throws IOException
	{
		System.out.println("\n Put bucket website NosuchBucket");
		System.out.println("===================================================");
		String bucketName="chttest100";
    ...
    private static void GetbucketWebsite_404_NosuchBucket() throws IOException
	{
    	System.out.println("\n Get bucket website NosuchBucket");
		System.out.println("===================================================");
		String bucketName="chttest100";
    ...
    private static void DeleteBucketWebsite_404_NosuchBucket() throws IOException
	{
    	System.out.println("\n Delete bucket website NosuchBucket");
		System.out.println("===================================================");
		String bucketName="chttest100";
    ...
    public static void main(String args[]) throws IOException
	{
		...
		/*
		 * test PutbucketWebsite_404_NosuchBucket
		 */
		PutbucketWebsite_404_NosuchBucket();
		
		/*
		 * test GetbucketWebsite_404_NosuchBucket
		 */
		GetbucketWebsite_404_NosuchBucket();
		
		/*
		 * test DeleteBucketWebsite_404_NosuchBucket
		 */
		DeleteBucketWebsite_404_NosuchBucket();
